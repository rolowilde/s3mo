...
{
    public static Dictionary<string, string> TagList = new()
    {
        ["0x00AE6C67"] = "BONE",
        ["0x00B2D882"] = "_IMG",
        ["0x00B552EA"] = "_SPT",
    ...
    public static List<string> DDSTypes = ["0x8FFB80F6", "0x00B2D882"];
    ...
    {
        char[] illegalChars = ['<', '>', ':', '"', '/', '\\', '|', '?', '*']; // https://stackoverflow.com/questions/1976007/what-characters-are-forbidden-in-windows-and-linux-directory-names
        bool ret = !(string.IsNullOrEmpty(name)
            || name.IndexOfAny(illegalChars) > -1
