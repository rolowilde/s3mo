...
public class ModModel
{
    ...
    public List<PackageModel> PackageModels => new(_packageModelLookup.Values);

    public bool TryGetPackageModel(string name, out PackageModel packageModel) =>
        _packageModelLookup.TryGetValue(name, out packageModel);

    private readonly Dictionary<string, PackageModel> _packageModelLookup = [];

    public List<ModModel> ConflictingModModels => new(_conflictingModModels);
    private readonly HashSet<ModModel> _conflictingModModels = [];
    ...
    public ModModel(string path)
    {
        ...
        {
            PackageModel packageModel = new(this, filePath);
...
public class ModModelComparer : IComparer<ModModel>
{
    ...
    private readonly SortBy _mode = SortBy.Priority;
