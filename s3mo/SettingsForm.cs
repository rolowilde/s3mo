...
public partial class SettingsForm : Form
{
    ...
    private void SettingsForm_FormClosing(object sender, FormClosingEventArgs e)
    {
        ...
        Settings.SetSettings(
            "BuildResourceCFG",
            resourcecfgTextBox.Text.Replace(Environment.NewLine, " \\n ")
        );
        ...
        Settings.SetSettings(
            "ClearSavedSimsDownloadedSims",
            savedSimsDownloadedsimsCheckBox.Checked
        );
    ...
    private void SettingsForm_Load(object sender, EventArgs e)
    {
        ...
        {
            if (
                Settings.TryGetSettings("SettingsY", out string obj2)
        ...
        if (
            Settings.TryGetSettings("ClearSimCompositorCache", out obj) && bool.TryParse(obj, out b)
        )
        {
        ...
        if (
            Settings.TryGetSettings("ClearDCCacheMissingdeps", out obj) && bool.TryParse(obj, out b)
        )
        {
